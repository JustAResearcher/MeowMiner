...
| OS                | Download                                                                                       |
|-------------------|------------------------------------------------------------------------------------------------|
| Windows 10/11 x64 | [**MeowMiner-1.0.17-windows-x64.zip**](../../releases/latest/download/MeowMiner-1.0.17-windows-x64.zip) |
| Linux x86_64      | [**MeowMiner-1.0.17-linux-x86_64.tar.gz**](../../releases/latest/download/MeowMiner-1.0.17-linux-x86_64.tar.gz) |
| HiveOS (custom miner) | [**MeowMiner-1.0.17-hiveos.tar.gz**](../../releases/latest/download/MeowMiner-1.0.17-hiveos.tar.gz) |
...
1. Download **MeowMiner-1.0.17-windows-x64.zip**.
...
```bash
curl -sL https://github.com/JustAResearcher/MeowMiner/releases/latest/download/MeowMiner-1.0.17-linux-x86_64.tar.gz \
  | tar -xz
...
```
https://github.com/JustAResearcher/MeowMiner/releases/latest/download/MeowMiner-1.0.17-hiveos.tar.gz
```
