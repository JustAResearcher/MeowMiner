...
| **Pearl (PRL)** | pearlhash (int8 tensor-core + BLAKE3) | `MeowMiner-pearl` | v1.6.36 |
...
| HiveOS sm86 package | [meowminer-sm86-lab-candidates-1.6.36.tar.gz](../../releases/download/v1.6.36/meowminer-sm86-lab-candidates-1.6.36.tar.gz) |
| MMPOS | [meowminer-pearl-1.6.23-mmpos.tar.gz](../../releases/download/v1.6.23/meowminer-pearl-1.6.23-mmpos.tar.gz) |

v1.6.36 restores the HiveOS sm86 lab package to the BK64 stage-2 no-sync drain
L2-set engine and stops forcing the strict fixed-grid scheduler by default. The
launcher now defaults to the binary's automatic sm_86 L2-block fast path while
still allowing explicit fixed-grid overrides for benchmarking.
...
| Field | Value |
|-------|-------|
| Installation URL | `https://github.com/JustAResearcher/MeowMiner/releases/download/v1.6.36/meowminer-sm86-lab-candidates-1.6.36.tar.gz` |
