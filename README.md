...
| **Pearl (PRL)** | pearlhash (int8 tensor-core + BLAKE3) | `MeowMiner-pearl` | v1.6.37 |
...
| HiveOS sm86 package | [meowminer-sm86-lab-candidates-1.6.37.tar.gz](../../releases/download/v1.6.37/meowminer-sm86-lab-candidates-1.6.37.tar.gz) |
| MMPOS | [meowminer-pearl-1.6.23-mmpos.tar.gz](../../releases/download/v1.6.23/meowminer-pearl-1.6.23-mmpos.tar.gz) |

v1.6.37 corrects the HiveOS sm86 lab launcher binary path so it selects the
packaged `MeowMiner-pearl.sm86` engine. It keeps the v1.6.36 behavior: BK64
stage-2 no-sync drain L2-set engine, automatic sm_86 L2-block fast path by
default, and explicit fixed-grid overrides only for benchmarking.
...
| Field | Value |
|-------|-------|
| Installation URL | `https://github.com/JustAResearcher/MeowMiner/releases/download/v1.6.37/meowminer-sm86-lab-candidates-1.6.37.tar.gz` |
